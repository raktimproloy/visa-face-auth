...
export default function SelfiePage() {
  ...
  const takePhoto = useCallback(async () => {
    if (cameraRef.current) {
      try {
        ...
        // Save photo to Redux store first
        dispatch(setPhoto(photo));
        console.log('Photo saved to Redux, redirecting to review page...');
  ...
  return (
    <div className="relative h-screen pb-20 flex flex-col justify-between items-center">
      {isCameraActive ? 
      // (
      //   // Camera is active - show camera component
      ...
      //           <button className="sm-btn mb-4">Hold Still</button>
      //           <button
      //             onClick={takePhoto}
      //             className="mobile-btn !flex items-center gap-2 max-w-[313px] !px-10 !mx-auto"
      //           >
      //             <svg
      ...
      (
        ...
        <>
          ...
          <button className="sm-btn !mt-5">Hold Still</button>
          <button
            onClick={startCamera}
            className="mobile-btn !flex items-center gap-2 max-w-[313px] !px-10"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="36"
